...
!function () {
    ...
    function e(a, b) {
        "function" == typeof a && (b = a, a = {}), a = a || {}, L.extend(H, a), delete H.fixLng, "string" == typeof H.ns && (H.ns = {
            namespaces: [H.ns],
            defaultNs: H.ns
        }), "string" == typeof H.fallbackNS && (H.fallbackNS = [H.fallbackNS]), ("string" == typeof H.fallbackLng || "boolean" == typeof H.fallbackLng) && (H.fallbackLng = [H.fallbackLng]), H.interpolationPrefixEscaped = L.regexEscape(H.interpolationPrefix), H.interpolationSuffixEscaped = L.regexEscape(H.interpolationSuffix), H.lng || (H.lng = L.detectLanguage()), H.lng ? H.useCookie && L.cookie.create(H.cookieName, H.lng, H.cookieExpirationTime, H.cookieDomain) : (H.lng = H.fallbackLng[0], H.useCookie && L.cookie.remove(H.cookieName)), F = L.toLanguages(H.lng), z = F[0], L.log("currentLng set to: " + z);
        var c = t;
        ...
        if (B && B.Deferred && (d = B.Deferred()), !H.resStore) {
            ...
            for (var f = 0, g = H.preload.length; g > f; f++) for (var h = L.toLanguages(H.preload[f]), i = 0, j = h.length; j > i; i++) e.indexOf(h[i]) < 0 && e.push(h[i]);
    ...
    function k(a, b) {
        ...
        "string" == typeof H.preload && (H.preload = [H.preload]);
        for (var e = 0, f = H.preload.length; f > e; e++) for (var g = L.toLanguages(H.preload[e]), h = 0, i = g.length; i > h; h++) d.indexOf(g[h]) < 0 && d.push(g[h]);
    ...
    function n() {
        function a(a, b, c) {
            if (0 !== b.length) {
                ...
                var f;
                if ("html" === d) f = H.defaultValueFromContent ? B.extend({defaultValue: a.html()}, c) : c, a.html(B.t(b, f)); else if ("text" === d) f = H.defaultValueFromContent ? B.extend({defaultValue: a.text()}, c) : c, a.text(B.t(b, f)); else if ("prepend" === d) f = H.defaultValueFromContent ? B.extend({defaultValue: a.html()}, c) : c, a.prepend(B.t(b, f)); else if ("append" === d) f = H.defaultValueFromContent ? B.extend({defaultValue: a.html()}, c) : c, a.append(B.t(b, f)); else if (0 === d.indexOf("data-")) {
                    var g = d.substr("data-".length);
                    f = H.defaultValueFromContent ? B.extend({defaultValue: a.data(g)}, c) : c;
                    var h = B.t(b, f);
                    a.data(g, h), a.attr(d, h)
                } else f = H.defaultValueFromContent ? B.extend({defaultValue: a.attr(d)}, c) : c, a.attr(d, B.t(b, f))
            }
        }
    ...
    function p(a, b) {
        var c = ",", d = "{", e = "}", f = L.extend({}, b);
        for (delete f.postProcess; -1 != a.indexOf(H.reusePrefix) && (E++, !(E > H.maxRecursion));) {
            var g = a.lastIndexOf(H.reusePrefix), h = a.indexOf(H.reuseSuffix, g) + H.reuseSuffix.length,
                i = a.substring(g, h), j = i.replace(H.reusePrefix, "").replace(H.reuseSuffix, "");
            if (-1 != j.indexOf(c)) {
                var k = j.indexOf(c);
    ...
    function w(a, b) {
        if (b && "object" != typeof b ? "sprintf" === H.shortcutFunction ? b = v.apply(null, arguments) : "defaultValue" === H.shortcutFunction && (b = {defaultValue: b}) : b = b || {}, void 0 === a || null === a) return "";
        "string" == typeof a && (a = [a]);
        var c = a[0];
        if (a.length > 1) for (var d = 0; d < a.length && (c = a[d], !s(c, b)); d++) ;
        var e, f = u(c, b), g = x(c, b), h = b.lng ? L.toLanguages(b.lng) : F, i = b.ns || H.ns.defaultNs;
    ...
    function x(a, b) {
        ...
        if (q(b)) {
            ...
            if (d = t(j, c), d != H.contextNotFound) return o(d, {context: b.context})
        }
        if (r(b)) {
            c = L.extend({}, b), delete c.count, c.defaultValue = H.pluralNotFound;
            var k = h + H.nsseparator + a + H.pluralSuffix, l = N.get(f[0], b.count);
        ...
        for (var m, n = a.split(H.keyseparator), s = 0, v = f.length; v > s && void 0 === m; s++) {
            ...
            if (void 0 !== A) {
                ...
                if ("string" == typeof A) A = o(A, b), A = p(A, b); else if ("[object Array]" !== B || H.returnObjectTrees || b.returnObjectTrees) {
                    if (null === A && H.fallbackOnNull === !0) A = void 0; else if (null !== A) if (H.returnObjectTrees || b.returnObjectTrees) {
        ...
        if (void 0 === m && !b.isFallbackLookup && (H.fallbackToDefaultNS === !0 || H.fallbackNS && H.fallbackNS.length > 0)) if (b.isFallbackLookup = !0, H.fallbackNS.length) {
            for (var G = 0, I = H.fallbackNS.length; I > G; G++) if (m = x(H.fallbackNS[G] + H.nsseparator + a, b)) {
    ...
    var z, A = this, B = A.jQuery || A.Zepto, C = {}, D = {}, E = 0, F = [], G = !1;
    ...
    var H = {
        ...
        toLanguages: function (a) {
            ...
            for (var d = 0; d < H.fallbackLng.length; d++) -1 === b.indexOf(H.fallbackLng[d]) && H.fallbackLng[d] && b.push(H.fallbackLng[d]);
            return b
        },
    ...
    var M = {
        load: function (a, b, c) {
            ...
            if (b.dynamicLoad) {
                ...
                if ("function" == typeof b.customLoad) b.customLoad(a, d.namespaces, b, f); else {
                    var g = o(b.resGetPath, {lng: a.join("+"), ns: d.namespaces.join("+")});
                    L.ajax({
            ...
            var e = o(c.resGetPath, {lng: a, ns: b});
            L.ajax({
                url: e, success: function (a) {
                    L.log("loaded: " + e), d(null, a)
                }, error: function (a, b, c) {
                    if (b && 200 == b || a && a.status && 200 == a.status) L.log("There is a typo in: " + e); else if (b && 404 == b || a && a.status && 404 == a.status) L.log("Does not exist: " + e); else {
                        var f = b ? b : a && a.status ? a.status : null;
                        L.log(f + " when loading " + e)
                    }
                    d(c, {})
            ...
            f[c] = d;
            var g = [];
            if ("fallback" === H.sendMissingTo && H.fallbackLng[0] !== !1) for (var h = 0; h < H.fallbackLng.length; h++) g.push({
                lng: H.fallbackLng[h],
                url: o(H.resPostPath, {lng: H.fallbackLng[h], ns: b})
            }); else if ("current" === H.sendMissingTo || "fallback" === H.sendMissingTo && H.fallbackLng[0] === !1) g.push({
                lng: a,
                url: o(H.resPostPath, {lng: a, ns: b})
            }); else if ("all" === H.sendMissingTo) for (var h = 0, i = e.length; i > h; h++) g.push({
                lng: e[h],
                url: o(H.resPostPath, {lng: e[h], ns: b})
            });
            for (var j = 0, k = g.length; k > j; j++) {
                var l = g[j];
                L.ajax({
                    url: l.url, type: H.sendType, data: f, success: function () {
                    ...
                    }, dataType: "json", async: H.postAsync
                })
            }
        }
    }, N = {
        rules: {
            ach: {
                ...
                name: "Aymará", numbers: [1], plurals: function () {
                    return 0
                }
            }, az: {
                ...
                name: "Tibetan", numbers: [1], plurals: function () {
                    return 0
                }
            }, br: {
                ...
                name: "Chiga", numbers: [1], plurals: function () {
                    return 0
                }
            }, cs: {
                ...
                name: "Dzongkha", numbers: [1], plurals: function () {
                    return 0
                }
            }, el: {
                ...
                name: "Persian", numbers: [1], plurals: function () {
                    return 0
                }
            }, fi: {
                ...
                name: "Indonesian", numbers: [1], plurals: function () {
                    return 0
                }
            }, is: {
                ...
                name: "Japanese", numbers: [1], plurals: function () {
                    return 0
                }
            }, jbo: {
                name: "Lojban", numbers: [1], plurals: function () {
                    return 0
                }
            }, jv: {
                ...
                name: "Georgian", numbers: [1], plurals: function () {
                    return 0
                }
            }, kk: {
                name: "Kazakh", numbers: [1], plurals: function () {
                    return 0
                }
            }, km: {
                name: "Khmer", numbers: [1], plurals: function () {
                    return 0
                }
            }, kn: {
                ...
                name: "Korean", numbers: [1], plurals: function () {
                    return 0
                }
            }, ku: {
                ...
                name: "Kyrgyz", numbers: [1], plurals: function () {
                    return 0
                }
            }, lb: {
                ...
                name: "Lao", numbers: [1], plurals: function () {
                    return 0
                }
            }, lt: {
                ...
                name: "Malay", numbers: [1], plurals: function () {
                    return 0
                }
            }, mt: {
                ...
                name: "Yakut", numbers: [1], plurals: function () {
                    return 0
                }
            }, sco: {
                ...
                name: "Sundanese", numbers: [1], plurals: function () {
                    return 0
                }
            }, sv: {
                ...
                name: "Thai", numbers: [1], plurals: function () {
                    return 0
                }
            }, ti: {
                ...
                name: "Tatar", numbers: [1], plurals: function () {
                    return 0
                }
            }, ug: {
                name: "Uyghur", numbers: [1], plurals: function () {
                    return 0
                }
            }, uk: {
                ...
                name: "Vietnamese", numbers: [1], plurals: function () {
                    return 0
                }
            }, wa: {
                ...
                name: "Wolof", numbers: [1], plurals: function () {
                    return 0
                }
            }, yo: {
                ...
                name: "Chinese", numbers: [1], plurals: function () {
                    return 0
                }
            }
            ...
            if (!N.currentRule || N.currentRule.lng !== a) {
                var b = a.split("-");
                N.currentRule = {lng: a, rule: N.rules[b[0]]}
            }
        }, get: function (a, b) {
            function c(b, c) {
                var d;
